...
From Undecidability Require
  TM.Reductions.HaltTM_1_to_SBTM2_HALT StackMachines.Reductions.SBTM2_HALT_to_HaltBSM.

Theorem HaltTM_to_MM_HALTS_ON_ZERO : HaltTM 1 ⪯ MM_HALTS_ON_ZERO.
Proof.
  eapply reduces_transitive. { exact HaltTM_1_to_SBTM2_HALT.reduction. }
  eapply reduces_transitive. { exact SBTM2_HALT_to_HaltBSM.reduction. }
