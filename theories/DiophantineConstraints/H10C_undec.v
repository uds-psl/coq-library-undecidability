...
From Undecidability.StringRewriting.Reductions Require SBTM_HALT_to_SR.
From Undecidability.TM.Reductions Require HaltTM_1_to_SBTM_HALT.
...
Proof. 
  ...
  eapply reduces_transitive; last apply HaltTM_1_to_SBTM_HALT.reduction.
