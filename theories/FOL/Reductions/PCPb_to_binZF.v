...
Section Model.
  ...
  Proof.
    ...
    - intros (y & Hy & z & Hz & H).
      ...
      apply M_ext; trivial.
      + intros a Ha % H. rewrite !eq_equiv in Ha. now apply M_pair.
      + intros a Ha % M_pair; trivial. apply H. now rewrite !eq_equiv.
    - exists (eval rho (Vector.hd v)).
      ...
      intros d. rewrite !eq_equiv. now apply M_pair.
    - intros (y & Hy & H).
      rewrite embed_sshift, sat_sshift1, IH in Hy; try apply in_hd. subst.
      apply M_ext; trivial.
