(** * Peano Arithmetic *)
(* ** Problems in PA *)
From Undecidability.FOL.Basics Require Import Syntax.Core.
From Undecidability.FOL.Basics.Axiomatizations.PA Require Export Signature FA Robinson PA.
Require Import Undecidability.FOL.Basics.Deduction.FullCore.
Require Import Undecidability.FOL.Basics.Semantics.Tarski.FullCore.
