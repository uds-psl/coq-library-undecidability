...
Definition HaltSBTMuniq : { '(existT _ M q) | forall c, trans M (q,c) = None /\ forall q', trans M (q',c) = None -> q' = q } * tape -> Prop.
 intros [[[M q] H] t]. exact (exists t', eval M Fin.F1 t q t'). Defined.
