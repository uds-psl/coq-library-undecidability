...
Require Import Undecidability.CounterMachines.CM1. (* CM1c4_HALT *)
...
Require Undecidability.CounterMachines.Reductions.MM2_HALTING_to_CM1c4_HALT.
...
(** 
  Comprehensive chain of many-one reductions from Turing machine halting to semi-unification 
    ...
    CM1c4_HALT : one-counter machine halting
...
Proof.
  ...
  constructor. { exact MM2_HALTING_to_CM1c4_HALT.reduction. }
  constructor. { exact CM1c4_HALT_to_SMNdl_UB.reduction. }
