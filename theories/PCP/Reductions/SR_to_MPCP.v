...
#[local] Hint Resolve incl_refl incl_appl incl_appr incl_nil_l : core.
#[local] Hint Resolve app_incl_l app_incl_R cons_incl : core.
...
Section SR_to_MPCP.
  ...
  Proof.
    ...
    - firstorder.
    - intros. intros [] [].
      + inv H0.  unfold P. do 3 (apply in_app_iff; right).
  ...
  Proof.
    ...
    - clear x H0. intros. inv H. destruct H1 as (A & ? & ?).
      ...
      + repeat (eapply incl_app); try assumption; unfold P.
        ...
        * eapply incl_appr. eapply incl_appl. now apply incl_sing.
  ...
  Proof.
    ...
    - assert (a el P) as [ -> | [ ->  | [ | [-> | (? & ? & ->)]]]]  % P_inv by (now apply H).
      ...
      + cbn -[fresh] in *.
        ...
        eapply list_prefix_inv in H2 as [<- ?]; [destruct y|..].
        * reflexivity.
      ...
      + destruct a as (u, v).
        ...
        { intros E. edestruct hash_sig. { unfold Sigma. rewrite !in_app_iff. do 2 right. now eapply sym_word_l; eauto. }
          reflexivity. }
      ...
      + cbn -[fresh] in *. rename x1 into a. destruct x.
        ...
        * inv H2.
          ...
          ** eapply cons_incl. eassumption.
          ** eapply incl_app. { eassumption. } now eapply incl_sing.
