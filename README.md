...
- Acceptance problem for two counters non-deterministic Minsky machines (`ndMM2_ACCEPT` in [`CounterMachines/ndMM2.v`](theories/CounterMachines/ndMM2.v)) with
...
- Entailment in Intuitionistic Multiplicative Sub-Exponential Linear Logic (`IMSELL_cf_PROVABILITY` in [`ILL/IMSELL.v`](theories/ILL/IMSELL.v))
