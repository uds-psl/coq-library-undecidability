...
[![CI](https://github.com/uds-psl/coq-library-undecidability/workflows/CI/badge.svg?branch=coq-8.19)](https://github.com/uds-psl/coq-library-undecidability/actions)
...
opam update
opam install coq-library-undecidability.1.1.1+8.19
```
...
opam repo add coq-released https://coq.inria.fr/opam/released
opam update
opam pin add coq-library-undecidability.dev+8.19 "https://github.com/uds-psl/coq-library-undecidability.git#coq-8.19"
```

### Manual installation

You need `Coq 8.19` built on OCAML `>= 4.09.1` (but we recommend and test OCaml version `4.14.1+flambda`) and the Template-Coq part of the [MetaCoq](https://metacoq.github.io/) package for Coq. If you are using opam 2 you can use the following commands to install the dependencies on a new switch:
